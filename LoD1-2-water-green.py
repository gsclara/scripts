...
plotter.subplot(1, 0)
plotter.add_mesh(clippedUw, scalars=Uw_scalars, clim=[0,4.9], stitle='Velocity Magnitude [m/s]', scalar_bar_args=sargs, cmap="plasma_r") 
...
plotter.subplot(1, 1)
plotter.add_mesh(clippedUwg, scalars=Uwg_scalars, clim=[0,4.9], stitle='Velocity Magnitude [m/s]', scalar_bar_args=sargs, cmap="plasma_r")
...
plotter.show(screenshot='/Users/claragarciasan/Documents/TUD/Research/DelftProject/LoDs/simulations/reducedMesh/U_LoD1-2-water-green_pedestrianheight.png')